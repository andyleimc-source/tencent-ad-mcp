...
export function registerWechatChannelsAdAccountTools(server: McpServer) {
  server.tool(
    "wechat_channels_ad_account_add",
    "视频号开户",
    {
  ...
  server.tool(
    "wechat_channels_ad_account_delete",
    "删除开户记录",
    {
      account_id: z.number().optional().describe("广告主账户ID"),
      params: z.record(z.string(), z.unknown()).optional().describe("其他请求参数 (key-value)"),
  ...
  server.tool(
    "wechat_channels_ad_account_get",
    "查询视频号开户记录",
    {
      account_id: z.number().optional().describe("广告主账户ID"),
      params: z.record(z.string(), z.unknown()).optional().describe("其他请求参数 (key-value)"),
  ...
  server.tool(
    "wechat_channels_ad_account_update",
    "视频号开户修改",
    {
      account_id: z.number().optional().describe("广告主账户ID"),
      params: z.record(z.string(), z.unknown()).optional().describe("其他请求参数 (key-value)"),
