...
export function registerMarketingTargetAssetsTools(server: McpServer) {
  server.tool(
    "marketing_target_assets_add",
    "创建推广内容资产",
    {
  ...
  server.tool(
    "marketing_target_assets_delete",
    "删除推广内容资产",
    {
      account_id: z.number().optional().describe("广告主账户ID"),
      params: z.record(z.string(), z.unknown()).optional().describe("其他请求参数 (key-value)"),
  ...
  server.tool(
    "marketing_target_assets_update",
    "更新推广内容资产",
    {
      account_id: z.number().optional().describe("广告主账户ID"),
      params: z.record(z.string(), z.unknown()).optional().describe("其他请求参数 (key-value)"),
